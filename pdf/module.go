...
type PDFModule struct{ pdfHandler *handlers.PDFHandler; pdfService *services.PDFGenerator; eventHandlers []core.EventHandler }
...
func (m *PDFModule) Services() []core.ServiceProvider { return []core.ServiceProvider{ &PDFServiceProvider{ pdfService: m.pdfService } } }
...
func (p *PDFServiceProvider) Factory(ctx core.ModuleContext) (interface{}, error) { return p.pdfService, nil }
