...
// PlanRequest is used for swagger docs (shared shape for create/update).
...
// PlanCreateRequest is used for plan creation.
...
// PlanUpdateRequest is used for plan updates.
