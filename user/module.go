...
import (
    ...
    "github.com/ae/base-server/modules/user/entities"
    "github.com/ae/base-server/modules/user/events"
    "github.com/ae/base-server/modules/user/handlers"
    "github.com/ae/base-server/modules/user/middleware"
    "github.com/ae/base-server/modules/user/services"
