...
func NewUserLoginHandler(handlers *BaseEventHandlers) core.EventHandler { return &UserLoginHandler{handlers: handlers} }
func (h *UserLoginHandler) EventType() string { return "user.login" }
func (h *UserLoginHandler) Handle(event interface{}) error { h.handlers.logger.Info("User login event received", "event", event); return nil }
...
func NewContactFormSubmittedHandler(handlers *BaseEventHandlers) core.EventHandler { return &ContactFormSubmittedHandler{handlers: handlers} }
func (h *ContactFormSubmittedHandler) EventType() string { return "contact.form.submitted" }
func (h *ContactFormSubmittedHandler) Handle(event interface{}) error { h.handlers.logger.Info("Contact form submitted event received", "event", event); return nil }
