...
func (m *EmailModule) Routes() []core.RouteProvider { return []core.RouteProvider{m.emailHandler, m.publicHandler} }
...
func (p *EmailServiceProvider) Factory(ctx core.ModuleContext) (interface{}, error) {
    if p.module.emailService == nil { p.module.emailService = services.NewEmailService() }
