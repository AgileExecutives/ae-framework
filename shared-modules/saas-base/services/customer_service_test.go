...
import (
	...
	baseModels "github.com/AgileExecutives/ae-framework/serverbase/modules/base/models"
...
func TestGetByTenant_ReturnsCustomers(t *testing.T) {
	...
	c1 := &baseModels.Customer{Name: "Alpha", Email: "alpha@example.com", PlanID: 1, TenantID: 42}
	c2 := &baseModels.Customer{Name: "Beta", Email: "beta@example.com", PlanID: 1, TenantID: 42}
...
func TestGetByTenant_IsolatedByTenantID(t *testing.T) {
	...
	c1 := &baseModels.Customer{Name: "OneA", Email: "onea@example.com", PlanID: 1, TenantID: 1}
	c2 := &baseModels.Customer{Name: "TwoA", Email: "twoa@example.com", PlanID: 1, TenantID: 2}
	if err := r.Save(context.Background(), c1); err != nil {
		t.Fatalf("save c1: %v", err)
	}
	if err := r.Save(context.Background(), c2); err != nil {
