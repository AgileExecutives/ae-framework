...
type StaticModule struct{ staticHandlers *handlers.StaticHandlers; db *gorm.DB }
...
func (m *StaticModule) Routes() []core.RouteProvider { return []core.RouteProvider{ handlers.NewStaticRoutes(m.staticHandlers, m.db) } }
