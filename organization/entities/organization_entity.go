...
func (e *OrganizationEntity) GetMigrations() []core.Migration { return []core.Migration{&OrgMigration001{}} }
...
func (m *OrgMigration001) Down(db *gorm.DB) error { return db.Migrator().DropTable(&models.Organization{}) }
