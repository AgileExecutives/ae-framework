...
describe('ForgotPasswordForm - Email Validation', () => {
  ...
  it('should display success message after successful submission', async () => {
    ...
    // Should have used shared router push mock
    expect(pushMock).toHaveBeenCalled()
    const calledWith = pushMock.mock.calls[0][0]
    expect(calledWith.path).toBe('/success')
    expect(calledWith.query.message).toBe('Password reset link sent to your email')
  })
  ...
  it('should disable submit button while submitting', async () => {
    ...
    // Should have started navigation (submission started)
    expect(pushMock).toHaveBeenCalled()
  })
  ...
  it('should clear form after successful submission', async () => {
    ...
    // Should have navigated to success (component navigates instead of clearing form)
    expect(pushMock).toHaveBeenCalled()
  })
})
